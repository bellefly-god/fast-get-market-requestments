...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 rounded-2xl shadow-card hover:shadow-card-hover hover:-translate-y-0.5",
        ...
        hero: "bg-primary text-primary-foreground rounded-2xl shadow-elevated hover:shadow-card-hover hover:-translate-y-1 active:translate-y-0 text-base font-semibold",
        upgrade: "bg-foreground text-background rounded-2xl hover:bg-foreground/90 hover:-translate-y-0.5 font-semibold",
      },
      size: {
